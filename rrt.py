...
class RRT(object):
    ...
    # Finds the node in the RRT tree that is closest to the given point.
...
def rrt_planner(racetrack, blue_cones, yellow_cones, screen, POINT_RADIUS, SCREEN_WIDTH, SCREEN_HEIGHT):
    ...
    # Generate an instance of RRT
    rrt = RRT(racetrack, screen, start, goal, blue_cones, yellow_cones, POINT_RADIUS, SCREEN_WIDTH, SCREEN_HEIGHT, neighbor_radius = 1000, step_size=30)
    
    # Generate the path using the RRT algorithm
    generated_path = rrt.generate_path()
